...
export default function LiveFeedOpeningStockDailySummary() {
    ...
    const handleExportToExcel = () => {
        ...
        XLSX.writeFile(wb, `Feed_Opening_Stock_${year}-${String(month).padStart(2, '0')}.xlsx`);
    };
