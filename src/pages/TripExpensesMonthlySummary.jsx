...
export default function TripExpensesMonthlySummary() {
    ...
    const fetchMonthlySummary = async () => {
        try {
            setLoading(true);
            setError('');
            const response = await api.get('/trip-expenses/monthly-summary', { params: { year } });
            if (response.data.success) {
                setData(response.data.data);
            }
        } catch (err) {
            console.error('Error fetching trip expenses monthly summary:', err);
    ...
    const handleMonthClick = (monthData) => {
        ...
        navigate(`/trip-expenses/daily-summary?month=${m}&year=${y}`);
    };
    ...
    const handleExportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Trip Expenses Summary");
        XLSX.writeFile(wb, `Trip_Expenses_Monthly_Summary_${year}.xlsx`);
    };
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
                            ...
                            Trip Expenses - Monthly Summary
                        </h1>
                        <p className="text-gray-600">Overview of all trip expenses</p>
                    </div>
                </div>
