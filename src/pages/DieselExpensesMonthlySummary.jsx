...
export default function DieselExpensesMonthlySummary() {
    ...
    const fetchMonthlySummary = async () => {
        try {
            setLoading(true);
            setError('');
            const response = await api.get('/diesel-expenses/monthly-summary', { params: { year } });
            if (response.data.success) {
                setData(response.data.data);
            }
        } catch (err) {
            console.error('Error fetching diesel expenses monthly summary:', err);
    ...
    const handleMonthClick = (monthData) => {
        ...
        navigate(`/diesel-expenses/daily-summary?month=${m}&year=${y}`);
    };
    ...
    const handleExportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Diesel Expenses Summary");
        XLSX.writeFile(wb, `Diesel_Expenses_Monthly_Summary_${year}.xlsx`);
    };
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
                            ...
                            Diesel Expenses - Monthly Summary
                        </h1>
                        <p className="text-gray-600">Overview of all diesel expenses</p>
                    </div>
                </div>
