...
export default function BirdsMortalityMonthlySummary() {
    ...
    const fetchMonthlySummary = async () => {
        try {
            setLoading(true);
            setError('');
            const response = await api.get('/birds-mortality/monthly-summary', { params: { year } });
            if (response.data.success) {
                setData(response.data.data);
            }
        } catch (err) {
            console.error('Error fetching birds mortality monthly summary:', err);
    ...
    const handleMonthClick = (monthData) => {
        ...
        navigate(`/birds-mortality/daily-summary?month=${m}&year=${y}`);
    };
    ...
    const handleExportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Birds Mortality Summary");
        XLSX.writeFile(wb, `Birds_Mortality_Monthly_Summary_${year}.xlsx`);
    };
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
                            ...
                            Birds Mortality - Monthly Summary
                        </h1>
                        <p className="text-gray-600">Overview of all birds mortality</p>
                    </div>
                </div>
